var app = new Vue({
  ...
  computed: {
    ...
    onlyUrl() {
      url = encodeURI(`https://api.whatsapp.com/send/?text=${this.messageTextarea}&phone=`)
      this.url = url
      return url
    }
  },
...
function copyToText() {
  var copyText = document.getElementById("text_url");
  copyText.select();
  copyText.setSelectionRange(0, 99999)
  document.execCommand("copy");
  alert("Copied the text: " + copyText.value.substr(0, 100));
}
